 ...
 */
export declare function FindWindowEx(hwndParent: ParamType[0], hwndChildAfter: ParamType[1], lpszClass: ParamType[2], lpszWindow: ParamType[3]): Promise<RetType>;
export {};
//# sourceMappingURL=FindWindowEx.d.ts.map