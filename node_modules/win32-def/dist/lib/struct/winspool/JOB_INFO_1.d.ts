...
export declare const PJOB_INFO_1: "JOB_INFO_1*";
export declare const JOB_INFO_1_Name = "JOB_INFO_1";
export declare const JOB_INFO_1_Init: typeof init;
/**
 ...
 */
export declare function JOB_INFO_1_Factory(): StructFactoryResult<JOB_INFO_1_Type>;
/**
 * JOB_INFO_1 structure,
 * The JOB_INFO_1 structure specifies print-job information such as the job-identifier value
 * @link https://learn.microsoft.com/en-us/windows/win32/printdocs/job-info-1
...
export {};
//# sourceMappingURL=JOB_INFO_1.d.ts.map